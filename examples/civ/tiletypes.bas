...
11020 X=OX+((5*S)*j*2)   : Y=OY+((5*S)*i*2) : gosub 11101
...
11052 if (i/2)=int(i/2) then X=X+(5*S)
11053 if (j/2)=int(j/2) then Y=Y-(5*S)
11055 color 0,255,255,128 : goto 11120
11060 X=OX+((5*S)*j*2) : Y=OY+((5*S)*i*2) : gosub 11101
11065 color 255,255,255,128 : goto 11110
11070 X=OX+((6*S)*j*2)  : Y=OY+((5*S)*i*2) : gosub 11101
11072 if (i/2)=int(i/2) then X=X+(6*S)
11075 color 255,0,0,128 : goto 11120
