1 rem VERTROT.BAS - Vertex Rotate test
2 rem ported from a QBASIC example done by bisqwit
3 rem https://bisqwit.iki.fi/jutut/kuvat/programming_examples/portalrendering/vertrot.bas
10 cls : home
...
3431  IF tz1<0 AND tz2<0 THEN goto 3750
3500    ' If the line crosses the player's viewplane, clip it.
...
3550    '
3551    yh=250 : ' originally 50 whuch is ok for 320x200
3560    x1 = -tx1 * 16 / tz1 : y1a = -yh / tz1 : y1b =  yh / tz1
3570    x2 = -tx2 * 16 / tz2 : y2a = -yh / tz2 : y2b =  yh / tz2
3700    '
3710    'LINE(50+x1,50+y1a)-(50+x2,50+y2a),14 'top (1-2 b)
3711    gosub 7014 : move rx+50+x1,ry+50+y1a : line rx+50+x2,ry+50+y2a
3720    'LINE(50+x1,50+y1b)-(50+x2,50+y2b),14 'bottom (1-2 b)
3721    gosub 7014 : move rx+50+x1,ry+50+y1b : line rx+50+x2,ry+50+y2b
3730    'LINE(50+x1,50+y1a)-(50+x1,50+y1b),6 'left (1)
3731    gosub 7006 : move rx+50+x1,ry+50+y1a : line rx+50+x1,ry+50+y1b
3740    'LINE(50+x2,50+y2a)-(50+x2,50+y2b),6 'right (2)
3731    gosub 7006 : move rx+50+x2,ry+50+y2a : line rx+50+x2,ry+50+y2b
3750  'END IF
3760  '
3800  ' Wait for screen refresh and swap page
3810  'SCREEN ,, page%, 1 - page% : page% = 1 - page%
3820  'WAIT &H3DA, &H8, &H8: WAIT &H3DA, &H8
3821  if us then update
3830  '
