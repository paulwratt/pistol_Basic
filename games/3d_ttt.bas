...
220 INPUT C$
230 IF C$="NO" or C$= "no" or C$="N" or C$="n" THEN 310
240 IF C$="YES" or C$= "yes" or C$="Y" or C$="y" THEN 270
...
450 INPUT S$
460 IF S$="NO" or S$= "no" or S$="N" or S$="n" THEN 630
470 IF S$="YES" or S$= "yes" or S$="Y" or S$="y" THEN 500
...
2080 DATA1,17,33,49,5,21,37,53,9,25,41,57,13,29,45,61
